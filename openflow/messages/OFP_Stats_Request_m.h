...
#ifndef _OFP_STATS_REQUEST_M_H_
#define _OFP_STATS_REQUEST_M_H_
...
/**
 * Class generated from <tt>messages/OFP_Stats_Request.msg:14</tt> by nedtool.
 * <pre>
 ...
 * </pre>
 */
class OFP_Stats_Request : public ::Open_Flow_Message
{
  protected:
    uint16_t type_var;
    uint16_t flags_var;
  ...
  private:
    void copy(const OFP_Stats_Request& other);

  protected:
    // protected and unimplemented operator==(), to prevent accidental usage
    bool operator==(const OFP_Stats_Request&);

  public:
    OFP_Stats_Request(const char *name=NULL, int kind=0);
    OFP_Stats_Request(const OFP_Stats_Request& other);
    virtual ~OFP_Stats_Request();
    OFP_Stats_Request& operator=(const OFP_Stats_Request& other);
    virtual OFP_Stats_Request *dup() const {return new OFP_Stats_Request(*this);}
...
inline void doPacking(cCommBuffer *b, OFP_Stats_Request& obj) {obj.parsimPack(b);}
inline void doUnpacking(cCommBuffer *b, OFP_Stats_Request& obj) {obj.parsimUnpack(b);}


#endif // ifndef _OFP_STATS_REQUEST_M_H_
